...
import { set } from '../../utility/Database/FirebaseDatabase'
...
const submitRegistrationForm = async () => {
  const isSet = await set('users/' + userId.value, {
    registered: true,
    ...
    <div class='fieldset'>
      ...
      <form @submit.prevent="submitRegistrationForm">
        <div class='row'>
          ...
          <input v-model="name" type="text" placeholder="Full Name" name='firstname' id='firstname' data-required="true"
            data-error-message="Your First Name is required">
        </div>
        <div class='row'>
          <label for='institutename'>School Name</label>
          <input v-model="institutename" type="text" placeholder="Institute Name" name='institutename' id='institutename'
            data-required="true" data-error-message="Your First Name is required">
        </div>
        <div class='row'>
          <label for="email">E-mail</label>
          <input type="text" :placeholder="userEmail" name='email' data-required="true" data-type="email"
            data-error-message="Your E-mail is required" :value="userEmail" readonly>
        </div>
